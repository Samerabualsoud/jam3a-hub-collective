...
const Hero = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-white to-royal-green-50 pt-6 pb-10 md:pt-8 md:pb-16">
      <div className="absolute top-0 left-0 w-full h-full bg-[url('data:image/svg+xml;base64,')]" style={{ opacity: '0.05' }}></div>
      <div className="container relative z-10 mx-auto px-4 md:px-6" dir={language === 'ar' ? 'rtl' : 'ltr'}>
        <div className="grid gap-5 lg:grid-cols-2 lg:gap-10">
          <div className="flex flex-col justify-center space-y-3">
            <div className="inline-flex items-center rounded-full border border-royal-green/30 bg-royal-green/10 px-4 py-1 text-sm font-medium text-royal-green animate-fade-in">
            ...
            <h1 className="text-4xl font-bold tracking-tight md:text-5xl lg:text-6xl animate-slide-in">
              {language === 'en' ? (
                <>
                  Buy Together,<br />
                  <span className="text-royal-green">Save Together</span>
                </>
              ) : (
                <>
                  اشتروا معًا،<br />
                  <span className="text-royal-green">وفروا معًا</span>
                </>
              )}
            </h1>
            ...
            <div className="flex flex-col space-y-2 sm:flex-row sm:space-x-4 sm:space-y-0">
              <Button size="lg" className="bg-royal-green hover:bg-royal-green-dark text-white">
            ...
            <div className="mt-4 flex flex-col space-y-2 text-sm text-muted-foreground">
              {content[language].benefits.map((benefit, index) => (
                <div key={index} className="flex items-center">
                  <CheckCircle2 className="mr-2 h-4 w-4 text-royal-green" />
                  <span>{benefit}</span>
                </div>
              ))}
            </div>
          ...
          <div className="flex items-center justify-center lg:justify-end">
            <div className="relative animate-float">
              <div className="absolute -left-4 -top-4 h-64 w-64 rounded-full bg-royal-green/20 blur-3xl"></div>
              <div className="absolute -bottom-4 -right-4 h-64 w-64 rounded-full bg-royal-green-accent/20 blur-3xl"></div>
                ...
                <div className="p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <div className="flex h-8 w-8 items-center justify-center rounded-full bg-royal-green">
                  ...
                  <div className="mt-3 relative overflow-hidden rounded-lg">
                    ...
                    />
                    <div className="absolute top-2 right-2 bg-royal-green text-white text-xs font-bold px-2 py-1 rounded-full">
                      -15%
                    </div>
                  </div>
                  <div className="mt-3">
                    <div className="flex items-end justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <p className="font-medium text-royal-green">23:45:12</p>
                      </div>
                    </div>
                  </div>
                  <div className="mt-3">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="text-royal-green">{content[language].complete}</span>
                    </div>
                    <div className="mt-2 h-2 w-full rounded-full bg-gray-100">
                      <div className="h-2 rounded-full bg-royal-green animate-pulse-soft" style={{ width: '80%' }}></div>
                    </div>
                  </div>
                  <div className="mt-3">
                    <Button className="w-full bg-royal-green hover:bg-royal-green-dark text-white transition-all duration-300 hover:shadow-jam3a">
